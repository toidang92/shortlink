...
| A02 Cryptographic Failures | Mitigated | [`SecureRandom`](../app/services/shortener_service.rb) for codes, [encrypted credentials](../config/credentials.yml.enc) |
| A03 Injection | Mitigated | ActiveRecord parameterized queries, [`URI.parse` validation](../app/controllers/urls_controller.rb) |
| A04 Insecure Design | Mitigated | [Service layer](../app/services/) separation, [input validation](../app/controllers/urls_controller.rb) |
...
| A08 Data Integrity | Mitigated | [DB constraints, unique indexes](../db/migrate/20260405042657_create_urls.rb) |
